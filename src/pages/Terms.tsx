  ...
  return (
    <Layout>
      <Hero 
        ...
        subtitle="Rules and regulations for the use of Louth Civic Trust's Website"
      />
      
      <Section title="TERMS AND CONDITIONS" className="bg-white">
        <div className="prose max-w-none">
          <p>
            These terms and conditions outline the rules and regulations for the use of Louth Civic Trust's Website.
            Louth Civic Trust is located at:
            14-16 Cornmarket Chambers Louth
            LN11 9PY – Lincolnshire, United Kingdom
          </p>
          
          <p>
            By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Louth Civic Trust's website if you do not accept all of the terms and conditions stated on this page.
          </p>
          ...
          <p>
            We employ the use of cookies. By using Louth Civic Trust's website you consent to the use of cookies in accordance with Louth Civic Trust's privacy policy.
          </p>
          ...
          <h3 className="text-xl font-bold mt-6 mb-3">License</h3>
          <p>
            Unless otherwise stated, Louth Civic Trust and/or it's licensors own the intellectual property rights for all material on Louth Civic Trust. All intellectual property rights are reserved. You may view and/or print pages from http://www.louthcivictrust.org for your own personal use subject to restrictions set in these terms and conditions.
          </p>
          
          <p>You must not:</p>
          <ul className="list-disc pl-8 mb-4">
            <li>Republish material from http://www.louthcivictrust.org</li>
            <li>Sell, rent or sub-license material from http://www.louthcivictrust.org</li>
            <li>Reproduce, duplicate or copy material from http://www.louthcivictrust.org</li>
          </ul>
          
          <p>Redistribute content from Louth Civic Trust (unless content is specifically made for redistribution).</p>
          
          <h3 className="text-xl font-bold mt-6 mb-3">Hyperlinking to our Content</h3>
          ...
          <p>No use of Louth Civic Trust's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
          
          <h3 className="text-xl font-bold mt-6 mb-3">Iframes</h3>
          <p>
            Without prior approval and express written permission, you may not create frames around our Web pages or use other techniques that alter in any way the visual presentation or appearance of our Web site.
          </p>
          
          <h3 className="text-xl font-bold mt-6 mb-3">Reservation of Rights</h3>
          <p>
            We reserve the right at any time and in its sole discretion to request that you remove all links or any particular link to our Web site. You agree to immediately remove all links to our Web site upon such request. We also reserve the right to amend these terms and conditions and its linking policy at any time. By continuing to link to our Web site, you agree to be bound to and abide by these linking terms and conditions.
          </p>
          
          <h3 className="text-xl font-bold mt-6 mb-3">Removal of links from our website</h3>
          <p>
          ...
          <h3 className="text-xl font-bold mt-6 mb-3">Content Liability</h3>
          <p>
